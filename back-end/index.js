...
// delete player
router.route('/player/delete/:id').get(verifyToken,(req,res)=>{
...
//get a game by id 
router.route('/game/:id').get(verifyToken,(req, res) =>
{
...
// create a game 
router.route('/game/add').post(verifyToken,(req, res)=>{
...
//Update a game 
router.route('/game/update/:id').post(verifyToken,(req, res)=>{
  game.findById(req.params.id, (err, game)=>{
    if(!game)
      return next(new Error('Could not load document'));
    else{
