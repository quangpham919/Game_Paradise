(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddGameComponent = /** @class */ (function () {
                function AddGameComponent(gameService, router, formBuilder) {
                ...
                AddGameComponent.prototype.addGame = function (title, platform, genre, rating, publisher, release, status) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddPlayerComponent = /** @class */ (function () {
                function AddPlayerComponent(gameService, playerService, formBuilder, router) {
                    this.gameService = gameService;
                ...
                AddPlayerComponent.prototype.addPlayer = function (name, ranking, score, time, status, favGame) {
                    var _this = this;
                    this.playerService.addPlayer(name, ranking, score, time, status, favGame).subscribe(function () {
                        _this.router.navigate(['/admin/main']);
                    });
                };
                AddPlayerComponent.prototype.fetchGame = function () {
                    var _this = this;
                    this.gameService
                        .getGames()
                        .subscribe(function (data) {
                        _this.listOfGames = data;
                        console.log("Requested game....");
                        console.log(_this.listOfGames);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var CustomErrorMatcher = /** @class */ (function () {
                function CustomErrorMatcher() {
                }
                CustomErrorMatcher.prototype.isErrorState = function (control, form) {
                    var isSubmitted = form && form.submitted;
                    return !!(control && control.invalid && (control.dirty || control.touched || isSubmitted));
                };
                return CustomErrorMatcher;
            }());
            var AdminLoginComponent = /** @class */ (function () {
                function AdminLoginComponent(router, authService) {
                    this.router = router;
                    this.authService = authService;
                    this.hide = true;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminMainPageComponent = /** @class */ (function () {
                function AdminMainPageComponent(playerService, router, gameService) {
                    this.playerService = playerService;
                    this.router = router;
                    this.gameService = gameService;
                ...
                AdminMainPageComponent.prototype.fetchPlayer = function () {
                    var _this = this;
                    this.playerService
                        .getPlayers()
                        .subscribe(function (data) {
                        _this.Player = data;
                        _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.Player);
                        _this.dataSource.paginator = _this.paginator;
                        _this.dataSource.sort = _this.sort;
                    });
                };
                AdminMainPageComponent.prototype.applyFilter = function (value) {
                    this.dataSource.filter = value.trim().toLowerCase();
                };
                AdminMainPageComponent.prototype.editPlayer = function (id) {
                    this.router.navigate(["admin/update_player/" + id]);
                };
                AdminMainPageComponent.prototype.deletePlayer = function (id) {
                    var _this = this;
                    this.playerService.deletePlayer(id).subscribe(function () {
                        _this.fetchPlayer();
                    });
                };
                return AdminMainPageComponent;
            }());
            AdminMainPageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminRegisterComponent = /** @class */ (function () {
                function AdminRegisterComponent(router, authService, snackBar) {
                    this.router = router;
                    this.authService = authService;
                ...
                AdminRegisterComponent.prototype.register = function (name, email, password) {
                    this.isLoading = true;
                    this.authService.register(name, email, password);
                };
                ;
                AdminRegisterComponent.prototype.ngOnDestroy = function () {
                    this.authStatusSub.unsubscribe();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditPlayerComponent = /** @class */ (function () {
                function EditPlayerComponent(gameService, playerService, router, route, snackBar, formBuilder) {
                    this.gameService = gameService;
                    this.playerService = playerService;
                    this.router = router;
                    this.route = route;
                ...
                EditPlayerComponent.prototype.createForm = function () {
                ...
                EditPlayerComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.params.subscribe(function (params) {
                        _this.id = params.id;
                        _this.playerService.getPlayerById(_this.id).subscribe(function (res) {
                            console.log(res);
                            _this.Player = res;
                            _this.updateForm.get('name').setValue(_this.Player.name);
                            _this.updateForm.get('ranking').setValue(_this.Player.ranking);
                            _this.updateForm.get('score').setValue(_this.Player.score);
                            _this.updateForm.get('time').setValue(_this.Player.time);
                            _this.updateForm.get('favGame').setValue(_this.Player.favGame);
                            _this.updateForm.get('status').setValue(_this.Player.status);
                            _this.updateForm.get('game_played').setValue(_this.Player.status);
                            _this.old_ranking = _this.Player.ranking;
                            _this.old_status = _this.Player.status;
                            _this.old_favGame = _this.Player.favGame;
                            _this.old_gamePlayed = _this.Player.gamePlayed;
                        });
                    });
                };
                EditPlayerComponent.prototype.fetchGame = function () {
                    var _this = this;
                    this.gameService
                        .getGames()
                        .subscribe(function (data) {
                ...
                EditPlayerComponent.prototype.updatePlayer = function (name, ranking, score, time, status, favGame, gamePlayed) {
                    var _this = this;
                    this.playerService.updatePlayer(name, ranking, score, time, status, favGame, this.id, gamePlayed).subscribe(function () {
                        _this.snackBar.open("Player has been updated successfully!!!", "OK", {
                            duration: 3000
                        });
                        _this.router.navigate(['/admin/main']);
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameConfigureComponent = /** @class */ (function () {
                function GameConfigureComponent(gameService, router) {
                    this.gameService = gameService;
                    this.router = router;
                ...
                GameConfigureComponent.prototype.ngOnInit = function () {
                };
                GameConfigureComponent.prototype.fetchGame = function () {
                    var _this = this;
                    this.gameService
                        .getGames()
                        .subscribe(function (data) {
                        _this.game_to_display = data;
                        _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.game_to_display);
                        _this.dataSource.paginator = _this.paginator;
                        _this.dataSource.sort = _this.sort;
                    });
                };
                GameConfigureComponent.prototype.editGame = function (id) {
                    this.router.navigate(["/admin/update_game/" + id]);
                };
                GameConfigureComponent.prototype.deleteGame = function (id) {
                    var _this = this;
                    this.gameService.deleteGame(id).subscribe(function () {
                        _this.fetchGame();
                    });
                };
                //Apply filter for filter bar in html page
                GameConfigureComponent.prototype.applyFilter = function (value) {
                    this.dataSource.filter = value.trim().toLowerCase();
                };
                return GameConfigureComponent;
            }());
            GameConfigureComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UpdateGameComponent = /** @class */ (function () {
                function UpdateGameComponent(gameService, router, route, snackBar, formBuilder) {
                    this.gameService = gameService;
                    this.router = router;
                    this.route = route;
                    this.snackBar = snackBar;
                ...
                UpdateGameComponent.prototype.createFrom = function () {
                    this.updateForm = this.formBuilder.group({
                        title: ['',],
                        platform: ['',],
                        genre: ['',],
                ...
                UpdateGameComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (params) {
                        _this.id = params.id;
                        _this.gameService.getGameById(_this.id).subscribe(function (res) {
                            _this.Game = res;
                            _this.updateForm.get('title').setValue(_this.Game.title);
                            _this.updateForm.get('platform').setValue(_this.Game.platform);
                            _this.updateForm.get('genre').setValue(_this.Game.genre);
                            _this.updateForm.get('rating').setValue(_this.Game.rating);
                            _this.updateForm.get('publisher').setValue(_this.Game.publisher);
                            _this.updateForm.get('release').setValue(_this.Game.release);
                            _this.updateForm.get('status').setValue(_this.Game.status);
                            _this.old_status = _this.Game.status;
                        });
                    });
                };
                UpdateGameComponent.prototype.updateGame = function (title, platform, genre, rating, publisher, release, status) {
                    var _this = this;
                    this.gameService.updateGame(title, platform, genre, rating, publisher, release, status, this.id).subscribe(function () {
                        _this.router.navigate(['/admin/main']);
                        _this.snackBar.open("Game has been updated successfully!!!", "OK", {
                            duration: 3000
                        });
                    });
                };
                return UpdateGameComponent;
            }());
            UpdateGameComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JoinGameComponent = /** @class */ (function () {
                function JoinGameComponent(gameService, playerService, router, route, snackBar, formBuilder) {
                    this.gameService = gameService;
                    this.playerService = playerService;
                    this.router = router;
                    this.route = route;
                ...
                JoinGameComponent.prototype.fetchGame = function () {
                    var _this = this;
                    this.gameService
                        .getGames()
                        .subscribe(function (data) {
                ...
                JoinGameComponent.prototype.JoinGame = function (gameTitle) {
                    var _this = this;
                    var status = "Unavailable";
                    this.playerService.joinGame(status, gameTitle, this.id).subscribe(function () {
                        _this.router.navigate(['/gamelobby']);
                        _this.snackBar.open("Please waitting to load game !!!", "OK", {
                            duration: 3000
                        });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayerRankingComponent = /** @class */ (function () {
                function PlayerRankingComponent(playerService, gameService, router, route) {
                    this.playerService = playerService;
                    this.gameService = gameService;
                    this.router = router;
                    this.route = route;
                ...
                PlayerRankingComponent.prototype.ngOnInit = function () {
                };
                PlayerRankingComponent.prototype.fetchTable = function () {
                    var _this = this;
                    this.playerService
                        .getPlayers()
                        .subscribe(function (data) {
                        _this.Player_to_display = data;
                        _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.Player_to_display);
                        _this.dataSource.paginator = _this.paginator;
                        _this.dataSource.sort = _this.sort;
                    });
                };
                PlayerRankingComponent.prototype.applyFilter = function (value) {
                    this.dataSource.filter = value.trim().toLowerCase();
                };
                PlayerRankingComponent.prototype.joinGame = function (id) {
                    this.router.navigate(["/join_game/" + id]);
                };
                return PlayerRankingComponent;
            }());
            PlayerRankingComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGuard = /** @class */ (function () {
                ...
                AuthGuard.prototype.canActivate = function (route, state) {
                    var isAuth = this.authService.getAuthStatus();
                    if (!isAuth) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                ...
                AuthenticationService.prototype.getAuthStatusListener = function () {
                    return this.authStatusListener.asObservable();
                };
                AuthenticationService.prototype.getAuthStatus = function () {
                    return this.isAuthenticated;
                };
                AuthenticationService.prototype.login = function (email, password) {
                    var _this = this;
                    return this.http.post("/api/admin/login", { email: email, password: password })
                ...
                AuthenticationService.prototype.register = function (name, email, password) {
                    var _this = this;
                    return this.http.post("/api/admin/login", { name: name, email: email, password: password }).subscribe(function () {
                        _this.router.navigate(['/admin/main']);
                    }, function (error) {
                        _this.authStatusListener.next(false);
                    });
                };
                AuthenticationService.prototype.autoAuthUser = function () {
                ...
                AuthenticationService.prototype.setAuthTimer = function (duration) {
                    var _this = this;
                ...
                AuthenticationService.prototype.saveAuthData = function (token, expirationDate) {
                    localStorage.setItem('token', token);
                    localStorage.setItem('expiration', expirationDate.toISOString());
                };
                AuthenticationService.prototype.clearAuthData = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameService = /** @class */ (function () {
                ...
                GameService.prototype.addGame = function (title, platform, genre, rating, publisher, release, status) {
                    var _this = this;
                    var game_to_add = {
                        title: title,
                        platform: platform,
                ...
                GameService.prototype.updateGame = function (title, platform, genre, rating, publisher, release, status, id) {
                    var game_to_update = {
                        title: title,
                        platform: platform,
                        genre: genre,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayerService = /** @class */ (function () {
                ...
                PlayerService.prototype.addPlayer = function (name, ranking, score, time, games, status) {
                    var player_to_add = {
                        name: name,
                        ranking: ranking,
                        score: score,
                ...
                PlayerService.prototype.updatePlayer = function (name, ranking, score, time, status, favGame, id, gamePlayed) {
                    var player_to_update = {
                        name: name,
                        ranking: ranking,
                        score: score,
                        time: time,
                ...
                PlayerService.prototype.joinGame = function (status, gamePlayed, id) {
                    var player_to_update = {
                        gamePlayed: gamePlayed,
                        status: status
                    };
